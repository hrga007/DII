...
const STATUS_MAP: Record<ProcessingStatus, { label: string; className: string }> = {
  ...
  completed_with_warnings: { label: 'Završeno s upozorenjima', className: 'bg-orange-100 text-orange-700' },
  completed_with_errors:   { label: 'Završeno s greškama',     className: 'bg-red-100 text-red-700' },
